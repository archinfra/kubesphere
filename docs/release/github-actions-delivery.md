...
两个仓库使用同一个 tag，例如 `v0.1.2`:

```bash
# console repo
git tag -a v0.1.2 -m "AI K8s Platform v0.1.2 console"
git push origin v0.1.2

# backend repo
git tag -a v0.1.2 -m "AI K8s Platform v0.1.2"
git push origin v0.1.2
```
...
```bash
sha256sum -c ai-k8s-platform-v0.1.2-amd64.run.sha256
chmod +x ai-k8s-platform-v0.1.2-amd64.run
./ai-k8s-platform-v0.1.2-amd64.run install -y \
...
```bash
./ai-k8s-platform-v0.1.2-amd64.run status
```
