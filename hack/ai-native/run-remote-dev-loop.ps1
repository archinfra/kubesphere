param(
    ...
    [string]$User = "root",
    [ValidateSet("backend", "frontend", "images", "values", "crds", "deploy", "smoke", "all")]
    [string]$Stage = "smoke",
...
ssh -o BatchMode=yes -o UpdateHostKeys=no $sshTarget "chmod +x '$RemoteScript' && '$RemoteScript' '$Stage'"
